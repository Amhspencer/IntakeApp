...
admins = [{:name => 'Savannah Dunlap', :email => 'savannah@gmail.com', :work_email => 'savannah@bcef.org', :password => 'killCancer', :phone_number => "1235673912", :admin => true},
		{:name => 'Andy', :email => 'andy@andy.com', :work_email => 'andy@bcef.org', :password => 'andy123', :phone_number => "1235673912", :admin => true}
		]

partners = [{:name => 'Katie Chen', :email => 'kchen@gmail.com', :work_email => 'katie@mountzion.org', :password => 'katieisgr8', :phone_number => "9871237654", :organization => 'Mount Zion Cancer Center', :admin => false},
			{:name => 'Bobby', :email => 'bobby@bobby.com', :work_email => 'bobby@mountzion.org', :password => 'bobby123', :phone_number => "9871237654", :organization => 'Mount Zion Cancer Center', :admin => false}]
